...
unlocked to sign the Rogue-Qt.app bundle.
...
allowing somebody to distribute a Rogue-Qt.app or rogue-qt-setup.exe with a valid
...
that the rogue-qt.exe file inside the installer had not been tampered with.
