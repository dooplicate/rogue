...
from test_framework.test_framework import RogueTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (RogueTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that rogue has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("rogued has not been built with zmq enabled.")
