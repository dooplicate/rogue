...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the RogueTestFramework
    pass

class ExampleTest(RogueTestFramework):
    # Each functional test is a subclass of the RogueTestFramework class.
    ...
    def custom_method(self):
        ...
        RogueTestFramework class so other tests can use it."""
