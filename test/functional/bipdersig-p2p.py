...
class BIP66Test(RogueTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # rogued is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and rogued produces more specific reject
            # reasons.
