...
# TestNode: A peer we use to send messages to rogued, and store responses.
...
class CompactBlocksTest(RogueTestFramework):
    ...
    # This test actually causes rogued to (reasonably!) disconnect us, so do this last.
    ...
    # Test that rogued requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for rogued to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # rogued will not send blocktxn responses for blocks whose height is
