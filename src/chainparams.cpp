...
{
    const char* pszTimestamp = "NY Times 18/Sep/2020 Facebook Tried to Limit QAnon. It Failed.";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1600487867, 2090006613, 0x1e0ffff0, 1, 50 * COIN);
        ...
        */
        ...
        checkpointData = (CCheckpointData) {
            {
                { 0, uint256S("0x5aaac381a70b77fcbc45906b9ed487432629e73527bc2192ecb1abd78bc539b3")},
                /*
        ...
        chainTxData = ChainTxData{
            ...
            1600487867, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1600487867, 2084797097, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x5aaac381a70b77fcbc45906b9ed487432629e73527bc2192ecb1abd78bc539b3"));
        assert(genesis.hashMerkleRoot == uint256S("0x4901c35d0811b0e51bba687f746665ecfed9c5c3e861d73ffeea3c6862aa6bf1"));
