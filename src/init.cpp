 ...
 * between rogued, and rogue-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/rogue-project/rogue>";
    const std::string URL_WEBSITE = "<https://rogue.org>";
...
/** Sanity checks
 *  Ensure that Rogue is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Rogue process is using the data directory.
