...
/** Rogue unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class RogueUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit RogueUnits(QObject *parent);

    /** Rogue units.
      @note Source: https://en.rogue.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ROGUE,
...
typedef RogueUnits::Unit RogueUnit;
