Rogue Core version 0.10.4 is now available from:

  <https://rogue.org/bin/rogue-core-0.10.4/>
...
- #6953 `43c2789` Split rogue-tx into its own package
- #6953 `dfe0d4d` Include rogue-tx binary on Debian/Ubuntu
