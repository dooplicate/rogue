Rogue Core version 0.13.1 is now available from:

  <https://rogue.org/bin/rogue-core-0.13.1/>
...
To receive security and update notifications, please subscribe to:
  ...
  <https://roguecore.org/en/list/announcements/join/>
...
- **Script versioning:** Segwit makes it easy for future soft forks to allow
  ...
  currently being researched by Rogue Core contributors that may use this
...
[versionbits FAQ]: https://roguecore.org/en/2016/06/08/version-bits-miners-faq/
...
- #8848 `7a34a46` Add NULLDUMMY verify flag in rogueconsensus.h (jl2012)
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.roguestats.com (TheBlueMatt, cdecker)
- #8944 `685e4c7` Remove bogus assert on number of oubound connections. (TheBlueMatt)
- #8949 `0dbc48a` Be more agressive in getting connections to peers with relevant services (gmaxwell)

### Build system
- #8293 `fa5b249` Allow building librogueconsensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_rogue by itself (luke-jr)
...
- #8829 `2a8bca4` Add rogue-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` rogue-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_rogueds() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name rogue.qrc  (roguesSG)
...
- #8817 `bcf3806` update rogue-tx to output witness data (jnewbery)
