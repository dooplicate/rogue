Rogue version 0.5.4 is now available for download at:
http://sourceforge.net/projects/rogue/files/Rogue/rogue-0.5.4/
...
http://gitorious.org/rogue/rogued-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Rogue-Qt notifications under Growl 1.3.
Increase required age of Rogue-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxRogue properly when installing Rogue-Qt over it. (Windows)
