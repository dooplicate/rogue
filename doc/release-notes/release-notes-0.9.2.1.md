Rogue Core version 0.9.2.1 is now available from:

  https://rogue.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ROGUE to 0.01 ROGUE
...
- Fix "Start rogue on system login"
