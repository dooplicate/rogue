Rogue version 0.6.2 is now available for download at:
http://sourceforge.net/projects/rogue/files/Rogue/rogue-0.6.2/
...
Fixed https://github.com/rogue/rogue/issues/1065, a bug that
