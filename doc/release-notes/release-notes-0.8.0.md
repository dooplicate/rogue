Rogue-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/rogue/files/Rogue/rogue-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Rogue
...
New/changed settings (command-line or rogue.conf file)
--------------------------------------------------------
