Rogue Core version 0.13.2 is now available from:
  ...
  <https://rogue.org/bin/rogue-core-0.13.2/>
...
- #8908 `4a974b2` Update rogue-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow rogue-tx to create v2 transactions (btcdrak)
