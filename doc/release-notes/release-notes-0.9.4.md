Rogue Core version 0.9.4 is now available from:

  https://rogue.org/bin/0.9.4/
...
this update is incompatible with the Rogue system and could lead to consensus
forks.

Rogue Core released binaries from https://rogue.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~rogue/+archive/ubuntu/rogue
- A third-party or self-compiled Rogue Core

upgrade to Rogue Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
