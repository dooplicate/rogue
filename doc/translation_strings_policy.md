...
This document provides guidelines for internationalization of the Rogue Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `rogue_en.ts` remains unchanged.
