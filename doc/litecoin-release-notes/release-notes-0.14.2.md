Rogue Core version 0.14.2 is now available from:

  <https://download.rogue.org/rogue-0.14.2.0/>
...
Rogue Core now supports P2SH addresses beginning with M on mainnet and Q on testnet.
...
This only affects users that have explicitly enabled UPnP through the GUI setting or through the -upnp option, as since the last UPnP vulnerability (in Rogue Core 0.10.4) it has been disabled by default.
...
- http://testnet.roguetools.com
- http://testnet.thrasher.io

Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/rogue-project/rogue/blob/master/src/chainparams.cpp#L220).
...
Rogue Core has supported automatically pruning the blockchain since 0.13.2. Pruning
...
now ZMQ can be used on Windows. Please see [this document](https://github.com/rogue-project/rogue/blob/master/doc/zmq.md) for
...
The Alert System was disabled and deprecated in Rogue Core 0.10.4 and removed in 0.13.2. 
...
here, originally written for Rogue but can also be used for Rogue:
[reducing-rogued-memory-usage.md](https://gist.github.com/laanwj/efe29c7661ce9b6620a7).
